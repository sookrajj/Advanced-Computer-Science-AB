  ...
  public static void main(String[] args) {
    try {
        ...
        for (int lcv = 0; lcv < peps.size(); lcv++) {
            ...
            double ex1 = peps.get(lcv).getNum()[0];
            double ex2 = peps.get(lcv).getNum()[1];
            double ex3 = peps.get(lcv).getNum()[2];
            double ex4 = peps.get(lcv).getNum()[3];
            double ex5 = peps.get(lcv).getNum()[4];
