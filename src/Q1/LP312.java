...
public class LP312 {
    static class ClLP312 {
        ...
        private void calc() {
            double total = 0;
            for (int lcv = 0; lcv < expenses.length; lcv++) {
                total += expenses[lcv];
            }
            percent = new double[expenses.length];
            for (int lcv = 0; lcv < expenses.length; lcv++) {
                percent[lcv] = (expenses[lcv]/total) * 100;
            }
        }
    ...
    public static void main(String[] args) {
        System.out.println("Enter the amount spent in the last month on the following items: ");
...
//Enter the amount spent in the last month on the following items:
//Food: 350.0
//Clothing : 300.0
//Entertainment: 200.0
//Rent: 1250.0
